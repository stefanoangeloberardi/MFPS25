...
and if $k>1$ to the $(k-1)$-unnamed argument $B_k$ in the assumption.
...
\item
for $k=1, \ldots, m$ the $k$-th unnamed argument $B_k$ in the conclusion 
is connected to the $k$-unnamed argument $B_k$ in the second assumption,
and if $k>1$ to the $(k-1)$-unnamed argument $B_k$ in the first assumption.
\end{enumerate}
