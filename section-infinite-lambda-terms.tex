...
the subset $\WTyped$ of well-typed terms of $\LAMBDA$ and a reduction relation for them. In the following sections,
...
says that (a) if some occurrence of $\lambda x^T$ is sent to $\lambda y^T$, then
...
We remark that $\sim_\alpha$ is an equivalence relation (the symmetricity is shown by (b)),
but is not a congruence relation, for example,
$(\lambda x.x)(\lambda y.y) \not\sim_\alpha (\lambda x.x)(\lambda x.x)$ though $\lambda y.y \sim_\alpha \lambda x.x$.
