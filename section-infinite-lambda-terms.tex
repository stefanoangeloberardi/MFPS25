...
\begin{Eg}
  ...
  %%%%%%%%%%%%%%
  %, and hence $\Sum(m)(n)$ is safe-normal. 
  % %%%%%%%%%%%%%
  % no, 0-safe normal means that all redexes have depth 1 or more, here is the opposite
  % there are redexes and all have depth 0.
  %%%%%%%%%%%%%%
\end{Eg}
