...
from the  $\golddagger$ above to the $\golddagger$ below.
\[
\infer[\lambda]{
  \vdash \Sum:\N, 
  %\goldN 
...
and we marked $\goldspadesuit$ the only progress point, which is cyclically repeated in the unique infinite trace.
