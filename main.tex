...
and circular $\lambda$-terms to the definition of GTC, and we check for 
...
\emph{(ii)} the existence of a limit $\lambda$-term \emph{with no unsolvable subterms}
for all possible infinite reductions.
\end{abstract}
\begin{keyword}
