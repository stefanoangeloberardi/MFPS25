...
familiar and shorter than the equivalent terms written in $\systemT$, yet their 
totality can be checked mechanically. Several circular syntax for $\systemT$ (that 
is, infinite regular terms with the global trace condition)
have been proposed, like $\CT$ by Anupam (\cite{2021-Anupam-Das}, \S 4.5, 
page 20), but without an explicit use of $\lambda$-abstraction.
...
%\\
In $\CTlambda$ we can define by simultaneous recursion 
...
\end{document}
>>>>>>> 2ddfd680cbe29d2e2321c3bb5cd82a810ab198e8
