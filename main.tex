...
program and shorter than the equivalent terms written in {\em T}. 
Another reason of interest is that all maps defined by a cyclic term are total. 
...
(but reductions can continue forever).
\end{abstract}
\begin{keyword}
