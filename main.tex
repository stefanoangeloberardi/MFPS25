...
is that terms in a circular syntax are written in fixed point-style, therefore are more natural and shorter than the equivalent terms written in $\systemT$, yet their totality can be checked mechanically. Several circular syntax for $\systemT$ (that is, infinite regular terms with the global trace condition)
